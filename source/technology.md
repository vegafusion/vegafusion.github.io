...
The server portion of the Runtime is wrapped in a Python API using [PyO3](https://github.com/PyO3/pyo3), resulting in the `vegafusion-python-embed` package.  The `vegafusion` package is used to integrate `vegafusion-python-embed` with Altair and the Python portion of VegaFusion Jupyter Widget.
